...
loginout(token) {
  return request(COMMON_BASE_URL + subDomain + '/user/loginout', false, 'get', {
    'token': token
  });
}
userLogedList(token) {
...
userDelete(token) {
  return request(COMMON_BASE_URL + subDomain + '/user/delete', false, 'post', {
    'token': token
  });
}
...
voteItemDetail (id) {
  return request(COMMON_BASE_URL + subDomain + '/vote/info', false, 'get', {
    'id': id
  });
}
...
yuyueItemDetail (id) {
  return request(COMMON_BASE_URL + subDomain + '/yuyue/info', false, 'get', {
    'id': id
  });
}
yuyueJoin (data) {
...
yuyueTeamDetail (teamId) {
  return request(COMMON_BASE_URL + subDomain + '/yuyue/info/team', false, 'get', {
    'teamId': teamId
  });
}
